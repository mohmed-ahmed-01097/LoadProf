...
% Parameters
numHouses         = 1000; % Number of households
...
for i = 1:classNum
    ...
    %loadprof_saveSurf(X_min, X_max, Y_min, Ymax, Z_min,  Z_mx,      Data, Xlabel, Ylabel, Zlabel,     %fileSave                                              );
    ...
    for k = 1:numMonths
        %loadprof_saveSurf(X_min, X_max, Y_min, Ymax, Z_min,  Z_mx,      Data,     %fileSave                                              );
...
for j = 1:length(plotdays)-1
    data = array(:, :, j);
    loadprof_saveplotsub(0    , plotdays(j)*numHours-1, 0, class_ZRange(3), 3, 2, ...         % X_min, X_max, Y_min,  Ymax, lineNum, lineWidth
...
loadprof_saveplot  ( 0, (numHours-1), 0, class_ZRange(4), classNum, ones(classNum)*5,...                % X_min, X_max, Y_min,  Ymax, lineNum, lineWidth
...
%clc;
disp('Plot the Avrage Day Load Profile ...');
loadprof_saveplot  ( 0, (houresNum-1), 0, class_ZRange(4), classNum, ones(classNum)*1,...               % X_min, X_max, Y_min,  Ymax, lineNum, lineWidth
...
% filter the hourly usage data from white noise
%==============================================================================================================================================
function [] = loadprof_saveSurf(X_min, X_max, Y_min, Ymax, Z_min, Z_mx, Data, Xlabel, Ylabel, Zlabel, fileSave)
...
[X, Y] = meshgrid(X_min:X_max,Y_min:Ymax);
surf(X, Y, Data);
colormap(jet(256));
...
% filter the hourly usage data from white noise
%==============================================================================================================================================
function [] = loadprof_saveSurfSub(X_min, X_max, Y_min, Ymax, Z_min, Z_mx, Data, Xlabel, Ylabel, Zlabel, fileSave)
...
% filter the hourly usage data from white noise
%==============================================================================================================================================
function [] = loadprof_saveplot(X_min, X_max, Y_min, Ymax, lineNum, lineWidth, Data, Title, Xlabel, Ylabel, legendNames, fileSave)
...
xlim([X_min X_max]);ylim([Y_min Ymax]);grid on;
...
% filter the hourly usage data from white noise
%==============================================================================================================================================
function [] = loadprof_saveplotsub(X_min, X_max, Y_min, Ymax, lineNum, lineWidth, Data, Title, Xlabel, Ylabel, legendNames, fileSave)
